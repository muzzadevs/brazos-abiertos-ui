      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid gap-6 md:gap-8 lg:gap-10 md:grid-cols-3">
          {[
            ...
            "Creemos que todo ser humano necesita salvación, la cual es un regalo de Dios, recibida por gracia mediante la fe en Jesucristo. No se gana por obras, sino por la obra perfecta de Cristo en la cruz. Creemos en el bautismo en agua por inmersión, como testimonio público de nuestra fe en Cristo.",
